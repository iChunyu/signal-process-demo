...
% Power spectrum density and filter design have been discussed in this report. The former one is a powerful tool to analyze signal in frequency domain while the later one includes a large class of filters and their applications.